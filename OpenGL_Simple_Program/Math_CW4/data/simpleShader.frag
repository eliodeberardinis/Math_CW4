...
uniform vec4 color; //if the flat modifier is added the colors will not be interpolated between vertices. flat must be added to the output of vertex shader as well
